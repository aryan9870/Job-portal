...
import { applicationsData, assets } from "../assets/assets";
            ...
            {applicationsData.map((applicant, index) => {
              return (
                <tr key={index} className="text-gray-700">
                  ...
                  <td className="py-2 px-4 border-b border-gray-200">{applicant.jobTitle}</td>
                  <td className="py-2 px-4 border-b border-gray-200">{applicant.location}</td>
                  <td className="py-2 px-4 border-b border-gray-200">
                    <a href="" target="_blank" className="bg-blue-50 text-blue-400 py-1 px-2 rounded inline-flex gap-2 items-center">
                      Resume <img src={assets.resume_download_icon} alt="" />
                    </a>
                  </td>
                  <td className="py-2 px-4 border-b relative border-gray-200">
                    <div className="relative inline-block text-left group">
                      <button className="text-gray-500 action-button text-3xl">...</button>
